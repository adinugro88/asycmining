...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            @foreach ($url as $db)
            @if ($db->coin == "BTC")
            <a type="button" class="btn btn-info {{ request()->is('btc*') ? 'active' : '' }}" href="/btc">{{ $db->coin }}</a>
            @else
            <a type="button" class="btn btn-info {{ request()->is('home*') ? 'active' : '' }}" href="/home">{{ $db->coin }}</a>
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <select name="filter" id="" class="form-select"  onchange="location =this.value;">
                            ...
                            <option value="/home/{{ $db->tgl }}" {{ $db->tgl == $tgl ? 'selected' : '' }}>
                                        {{ \Carbon\Carbon::parse($db->tgl)->format('d M ') }}
                            </option>
